...
struct player_t
{
    ...
    const char          *group_invite_name;     /* GROUP_BIT_INVITE: This player name can invite you */
    ...
    int                 exp_bonus;                  /* player exp bonus, currently resets after one kill */
    int                 exp_bonus_amulet;           /* exp bonus on amulet with last_grace*/
    ...
    uint8               bed_status;
    uint8               group_mask;                    /* group mask use GROUP_BIT_XX */
