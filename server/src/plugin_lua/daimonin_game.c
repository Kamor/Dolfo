...
static struct constant_decl preset_game_constants[] =
{
    ...
    /* identification modes (constants not defined by server) -- deprecated */
    {"IDENTIFY_NORMAL", 0},
    {"IDENTIFY_ALL",    1},
    {"IDENTIFY_MARKED", 2},
    ...
    {"QUEST_NORMAL",   SUBTYPE_QUEST_TRIGGER_NORMAL},
    {"QUEST_KILL",     SUBTYPE_QUEST_TRIGGER_KILL},
    {"QUEST_KILLITEM", SUBTYPE_QUEST_TRIGGER_KILLITEM},
    {"QUEST_ITEM",     SUBTYPE_QUEST_TRIGGER_ITEM},
    ...
    {"GUILD_NO",  0},
    {"GUILD_IN",  SUBTYPE_GUILD_IN},
    {"GUILD_OLD", SUBTYPE_GUILD_OLD},
    ...
    /* skills (skill.h) */
    {"SKILL_ALCHEMY",            SK_ALCHEMY},
    {"SKILL_DIVINE_PRAYERS",     SK_DIVINE_PRAYERS},
    {"SKILL_FIND_TRAPS",         SK_FIND_TRAPS},
    {"SKILL_LITERACY",           SK_LITERACY},
    {"SKILL_MAGIC_DEVICES",      SK_MAGIC_DEVICES},
    {"SKILL_MELEE_CLEAVE",       SK_MELEE_CLEAVE},
    {"SKILL_MELEE_IMPACT",       SK_MELEE_IMPACT},
    {"SKILL_MELEE_PIERCE",       SK_MELEE_PIERCE},
    {"SKILL_MELEE_SLASH",        SK_MELEE_SLASH},
    {"SKILL_MELEE_MASTERY_2H",   SK_MELEE_MASTERY_2H},
    {"SKILL_MELEE_MASTERY_POLE", SK_MELEE_MASTERY_POLE},
    {"SKILL_PUNCHING",           SK_PUNCHING},
    {"SKILL_RANGE_BOW",          SK_RANGE_BOW},
    {"SKILL_RANGE_SLING",        SK_RANGE_SLING},
    {"SKILL_RANGE_XBOW",         SK_RANGE_XBOW},
    {"SKILL_REMOVE_TRAP",        SK_REMOVE_TRAP},
    {"SKILL_THROWING",           SK_THROWING},
    {"SKILL_WIZARDRY_SPELLS",    SK_WIZARDRY_SPELLS},
    ...
    /* Target modes (los.h) */
    {"TARGET_SELF",   LOS_TARGET_SELF},
    {"TARGET_ENEMY",  LOS_TARGET_ENEMY},
    {"TARGET_FRIEND", LOS_TARGET_FRIEND},
    ...
    /* Egoitem modes (egoitem.h) */
    {"EGOITEM_MODE_UNBOUND", EGOITEM_MODE_UNBOUND},
    {"EGOITEM_MODE_PLAYER",  EGOITEM_MODE_PLAYER},
    {"EGOITEM_MODE_GUILD",   EGOITEM_MODE_GUILD},
    {"EGOITEM_MODE_CLAN",    EGOITEM_MODE_CLAN},

    /* Move returns (move.h) */
    {"MOVE_RETURN_SANITY",           MOVE_RETURN_SANITY},
    {"MOVE_RETURN_SUCCESS",          MOVE_RETURN_SUCCESS},
    {"MOVE_RETURN_INSERTION_FAILED", MOVE_RETURN_INSERTION_FAILED},
    {"MOVE_RETURN_DESTROYED",        MOVE_RETURN_DESTROYED},
    {"MOVE_RETURN_MOVED",            MOVE_RETURN_MOVED},
};
